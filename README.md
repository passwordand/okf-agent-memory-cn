> [!NOTE]
> This fork adds Chinese search support with `go-ego/gse` while keeping the OKF CLI, MCP tools, and Markdown bundle format compatible. See the [Chinese README](README-cn.md) and the [OKF improvement and deployment docs](docs/agent-memory/).
